namespace ScopeSetupApp.Format
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.addFormatButton.Click += new System.EventHandler(this.addFormatButton_Click);
			// 
			// oldFormat_checkBox
			// 
			...
			this.oldFormat_checkBox.Click += new System.EventHandler(this.oldFormat_checkBox_Click);
			// 
			// FormatsdataGridView
			// 
